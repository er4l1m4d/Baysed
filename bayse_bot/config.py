...
class Settings:
    ...
    position_size: Decimal = field(default_factory=lambda: _decimal("POSITION_SIZE", os.getenv("POSITION_SIZE_NGN", "100")))
    max_trades: int = field(default_factory=lambda: int(os.getenv("MAX_TRADES_PER_DAY", "0")))
    daily_loss_limit: Decimal = field(default_factory=lambda: _decimal("DAILY_LOSS_LIMIT", os.getenv("DAILY_LOSS_LIMIT_NGN", "0")))
    ...
    min_liquidity: Decimal = field(default_factory=lambda: _decimal("MIN_ENTRY_LIQUIDITY", os.getenv("MIN_ENTRY_LIQUIDITY_NGN", "10")))
